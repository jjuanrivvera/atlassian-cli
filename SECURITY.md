...
[GitHub Security Advisories](https://github.com/jjuanrivvera/atlassian-cli/security/advisories/new).
...
`atlassian agent guard` generates host configuration that blocks irreversible operations and
