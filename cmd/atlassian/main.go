// Command atlassian is a command-line client for Jira, Jira Software, Jira Service
...
import (
	...
	"github.com/jjuanrivvera/atlassian-cli/commands"
)

func main() {
	// Ctrl-C must cancel work in flight, not just kill the process between requests: an
	// --all walk over a large Jira instance, a retry backoff, and a multi-page sync all
	// check this context. Every call site threads cmd.Context() from here.
